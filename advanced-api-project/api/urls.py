...
urlpatterns = [
    ...
    path('books/<int:pk>/update/', views.BookUpdateView.as_view(), name='book-update'),  # MUST HAVE 'books/update'
    path('books/<int:pk>/delete/', views.BookDeleteView.as_view(), name='book-delete'),  # MUST HAVE 'books/delete'
